...
public class Customer implements java.io.Serializable{ 
	...
	private String CCN; 
	//CCN is taken as a string because the max 16 digit number (9999999999999999) is larger than max int size
			//   We only use the last 4 digits of CCN in the program, so it was not necessary to make CCN a Long
	private int key;
	private String password;
	private WishList wishList;

	private RecentlyWatchedStack recentlyWatchedStack;
	...
	public Customer(String name0, String email0, String CCN0, String password0){
		...
		recentlyWatchedStack = new RecentlyWatchedStack();
	}
	...
	public RecentlyWatchedStack getRecentlyWatchedStack(){
		return recentlyWatchedStack;
	}
